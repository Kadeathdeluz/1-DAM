 ...
 */
package UF11_ExerciciB8;
import java.io.*;
import java.util.*;
/**
 * UF11 Exercici B8: Programa que llig un document de text i mostra per pantalla algunes dades
 ...
 * Utilitza la classe FileReader
 */
public class UF11_ExerciciB8 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (File llibre : llistaLlibres) {
                ...
                // Lector d'arxius
                FileReader lector = new FileReader(llibre);
                ...
                while ((linia=bufferLector.readLine())!=null) {
                    // Línia
                    numLin++;
            ...
            System.out.println("Error: La carpeta no existeix o està buida.");
        } catch (Exception e) {
